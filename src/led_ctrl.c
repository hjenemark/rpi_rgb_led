...
{
  gpio_init(led_map[0].bcmPinNo, GPIO_OUTPUT, GPIO_HIGH);
  gpio_init(led_map[1].bcmPinNo, GPIO_OUTPUT, GPIO_HIGH);
  gpio_init(led_map[2].bcmPinNo, GPIO_OUTPUT, GPIO_HIGH);
